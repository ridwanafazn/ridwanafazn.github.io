...
export default function Projects() {
  ...
  return (
    <section id="projects" className="scroll-mt-32 py-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
           ...
           <p className="text-slate-400 max-w-xl">
             Selected case studies demonstrating scalable architecture and complex problem solving.
           </p>
        </div>
      ...
      <div className="mt-8 md:hidden">
        <Button variant="outline" className="w-full border-slate-800 bg-slate-900/50 text-slate-300 hover:bg-slate-800 hover:text-white">
          <Github className="mr-2 h-4 w-4" />
          View Full Archive
        </Button>
      </div>
